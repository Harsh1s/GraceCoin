...
class AES
{
    ...
    private:
        // Rijndael S-box as a 2-dimentional matrix
        ...
        // Rijndael inverse S-box as a 2-dimentional matrix
        const uint8_t inv_sbox[16][16] = {
            ...
            {0x54,
             ...
             0x42, 0xfa, 0xc3, 0x4e},
            {0x8, 0x2e, 0xa1, 0x66, 0x28, 0xd9, 0x24,
            ...
            {0x90, 0xd8, 0xab,
             ...
             0x6},
            {0xd0, 0x2c, 0x1e, 0x8f, 0xca, 0x3f, 0xf, 0x2, 0xc1, 0xaf,
             0xbd, 0x3, 0x1, 0x13, 0x8a, 0x6b},
            {0x3a, 0x91, 0x11, 0x41, 0x4f,
            ...
            {0x47, 0xf1, 0x1a, 0x71, 0x1d, 0x29,
             0xc5, 0x89, 0x6f, 0xb7, 0x62, 0xe, 0xaa, 0x18, 0xbe, 0x1b},
            {0xfc,
             0x56, 0x3e, 0x4b, 0xc6, 0xd2, 0x79, 0x20, 0x9a, 0xdb, 0xc0, 0xfe,
             0x78, 0xcd, 0x5a, 0xf4},
            {0x1f, 0xdd, 0xa8, 0x33, 0x88, 0x7, 0xc7,
    ...
    public:
        std::string multi_block_process_enc(std::string user_in, std::shared_ptr<uint8_t> key, uint8_t Nb, uint8_t Nk,
                                            uint8_t Nr)
        {
        ...
        std::string multi_block_process_dec(std::string user_in, std::shared_ptr<uint8_t> key, uint8_t Nb, uint8_t Nk,
                                            uint8_t Nr)
        {
